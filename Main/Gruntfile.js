...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        sprite: {
            sonic: {
                src: ['<%= settings.src %>/img/sonic-sprites/*.png'],
                destImg: '<%= settings.dist %>/img/sonic-sprites.png',
                destCSS: '<%= settings.src %>/css/_sonic-sprites.scss',
                cssFormat: 'scss',
                algorithm: 'left-right',
                imgPath: '../img/sonic-sprites.png',
                algorithmOpts: {
            ...
            background: {
                src: ['<%= settings.src %>/img/background-sprites/*.png'],
                destImg: '<%= settings.dist %>/img/background-sprites.png',
                destCSS: '<%= settings.src %>/css/_background-sprites.scss',
                cssFormat: 'scss',
                //algorithm: 'left-right',
                imgPath: '../img/background-sprites.png',
                algorithmOpts: {
                    // Skip sorting of images for algorithm (useful for sprite animations)
                    'sort': false
                }
